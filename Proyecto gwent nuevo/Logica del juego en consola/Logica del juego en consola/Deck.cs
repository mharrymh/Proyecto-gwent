...
namespace Assets.Scripts
{
    public class CardDatabase
    {
        ...
        private void CreateLigthDeck()
        {
            ...
            //Increment card
            LightDeck.Add(new Card.SpecialCard("Hércules", CardFaction.Light, EffectType.IncrementFile, SpecialType.Increment, "M"));
            LightDeck.Add(new Card.SpecialCard("Artemisa", CardFaction.Light, EffectType.IncrementFile, SpecialType.Increment, "R"));
            LightDeck.Add(new Card.SpecialCard("Helios", CardFaction.Light, EffectType.IncrementFile, SpecialType.Increment, "S"));
        }
        //Dark faction cards
        private void CreateDarkDeck()
        {
            ...
            //Increment cards
            DarkDeck.Add(new Card.SpecialCard("Gorgón", CardFaction.Dark, EffectType.IncrementFile, SpecialType.Increment, "M"));
            DarkDeck.Add(new Card.SpecialCard("Euríale", CardFaction.Dark, EffectType.IncrementFile, SpecialType.Increment, "R"));
            DarkDeck.Add(new Card.SpecialCard("Tánatos", CardFaction.Dark, EffectType.IncrementFile, SpecialType.Increment, "S"));
        }
